...
public class HelloProxy implements jaxws.Hello {
  private String _endpoint = null;
  private jaxws.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new jaxws.HelloServiceLocator()).getHelloPort();
      if (hello != null) {
        if (_endpoint != null)
