...
public class HelloServiceLocator extends org.apache.axis.client.Service implements jaxws.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://localhost:8888/webdemo/jaxws/hello";
    ...
    public jaxws.Hello getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            jaxws.HelloPortBindingStub _stub = new jaxws.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (jaxws.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                jaxws.HelloPortBindingStub _stub = new jaxws.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jaxws/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jaxws/", "HelloPort"));
        }
